                ...
                <tr class="w-64">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div class="inline-flex rounded-md shadow-xs" role="group">
                            <a href="{{ route('nutritional-plans.pdf', $plan) }}" target="_blank" class="bg-blue-500 hover:bg-blue-600 px-2 py-2  inline-flex items-center text-sm font-medium text-blue-700 bg-white border-1 border-blue-600 rounded-xl hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
